...
puts '  }'
puts
puts '  // Prevent access to Discover for logged-out users'
puts '  document.addEventListener("DOMContentLoaded", function() {'
puts '    document.getElementById("discoverLink").addEventListener("click", function(event) {'
...
puts '          </li>'
puts '          <li class="nav-item">'
puts '            <a class="nav-link" href="#">Discover</a>'
puts '          </li>'
puts '        </ul>'
puts '      </div>'
puts '    </div>'
