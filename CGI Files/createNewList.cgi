...
puts "            <option value='Private'>Private - only you can view</option>"
puts "          </select>"
puts "          <br>"
puts "          <label>Description</label>"
puts "          <textarea name='description' class='form-control' placeholder='List Description' required></textarea>"
puts "          <br>"
puts "          <button class='btn btn-success' type='submit' name='saveList'>Save List</button>"
puts "        </form>"
puts "      </div>"
puts "    </div>"
puts "  </div>"
